...
def create_data_model(num_vehicle=4):
    """Stores the data for the problem."""
    assert num_vehicle <= 4
    data = {}
    ...
    data['vehicle_capacities'] = [15, 15, 15, 15][:num_vehicle]
    data['depot'] = 0
    return data
...
def print_solution(data, manager, routing, assignment):
    ...
    for vehicle_id in range(data['num_vehicles']):
        ...
        while not routing.IsEnd(index):
            ...
            list_route.append(node_index)
            list_load.append(route_load)
        ...
        results[vehicle_id] = (list_route, list_load)
        total_distance += route_distance
        total_load += route_load
    return results, dropped_node_set, total_distance, total_load
